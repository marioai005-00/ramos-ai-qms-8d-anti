...
# Define the complete modal org tree system
new_modal_org_tree_code = '''    /* ========================================================================= */
...
# Find CFT ORG TREE MODAL & TEAM MANAGEMENT start and end in content
...
if s_idx != -1 and e_idx != -1:
    content = content[:s_idx] + new_modal_org_tree_code + '\n\n' + content[e_idx:]
    print('Updated modal org tree implementation successfully!')
else:
    print('Could not find markers, fallback replacement...')

with open(r'g:\내 드라이브\AI_Place\Work\11_AI_Customer_Nonconformance_8D_System\index.html', 'w', encoding='utf-8') as f:
    f.write(content)
print('Saved changes to index.html!')
