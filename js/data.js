/* ========================================================================= */
    ...
    const INITIAL_CASES = [
      ...
      },
      {
        ...
        application: '차량용 In-Vehicle Infotainment (IVI) 시스템',
        ...
        inspectQty: 5000,
        ppm: 600,
        claimTitle: '차량용 IVI 85℃ 고온 챔버 환경 신뢰성 시험 중 eMMC I/O 응답 지연 및 초기화 Timeout',
        ...
        d2: {
          problemWhat: 'IVI 고온 환경 챔버 동작 중 eMMC CMD Timeout 및 Read I/O 응답 지연',
          problemWhere: 'LGE 평택 VS 인포테인먼트 신뢰성 검증 챔버',
          problemWhen: '2026.09.01 19:30',
          problemWho: 'LGE VS 전장품질팀 박진석 책임',
          problemWhich: 'RM-AUTO-EM51-032G / Lot #EM2608-VS02',
          problemHow: '85℃ 고온 방치 48시간 후 Cold Boot 시 간헐적 초기화 지연',
          problemHowMany: '3 / 5,000ea (600 PPM)',
          isIsNot: [],
          hypotheses: [
            { id: 'HYP-01', title: '고온 동작 시 컨트롤러 내부 클럭 드리프트 가능성', confidence: 'Medium', status: 'Under Investigation', requiredEvidence: ['오실로스코프 클럭 파형'] }
          ]
        },
        d3: { materialFlow: [], actions: [], effectivenessStatement: '해당 Lot 출하 잠금 및 LGE 평택 라인 격리 조치 완료' },
