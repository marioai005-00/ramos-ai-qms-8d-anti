/* SIDEBAR TAB SWITCHING & EXACT FOLDER ORG TREE RENDER                      */
    ...
    const DEFAULT_ORG_SKILLS = {
      ...
      'shnam1228@ramostek.com': { jobDesc: '전략소싱팀 LGE eMMC 영업 담당, 고객사 소통, 공급 계약', products: 'eMMC 5.1, Flash', skills: 'LGE 영업 대응, 납기/단가 조율, 계약 관리' },
      'lhyduddlgk@ramostek.com': { jobDesc: '전략소싱팀 LGE eMMC CS 담당, 고객 불량 클레임 1차 접수 및 소통', products: 'eMMC 5.1, Flash', skills: 'LGE CS 대응, 초동 소통, 클레임 접수' },
